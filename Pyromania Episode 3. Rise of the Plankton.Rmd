...
### Time 1
######## T1 model
m1.AF.T1<-gam(af_sum ~ Treatment + s(plant.mass..g, by= Treatment), subset = Time=="T1", data = fcm.df, method = "REML")

m2.AF.T1<-gam(af_sum ~  Treatment + s(plant.mass..g), subset = Time=="T1", data = fcm.df, method = "REML")

m3.AF.T1<-gam(af_sum ~  s(plant.mass..g), subset = Time=="T1", data = fcm.df, method = "REML")
...
AF.T1.mod.plot<-
  ...
  geom_point(data=fcm.df[(fcm.df$Time=="T1"),], 
...
### Time 3
######## T3 model
m1.AF.T3<-gam(af_sum ~ Treatment + s(plant.mass..g, by= Treatment), subset = Time=="T3", data = fcm.df, method = "REML")

m2.AF.T3<-gam(af_sum ~  Treatment + s(plant.mass..g), subset = Time=="T3", data = fcm.df, method = "REML")

m3.AF.T3<-gam(af_sum ~  s(plant.mass..g), subset = Time=="T3", data = fcm.df, method = "REML")
...
AF.T3.mod.plot<-
  ...
  geom_point(data=fcm.df[(fcm.df$Time=="T3"),], 
             aes(x=plant.mass..g, y=af_sum, color=Treatment)) +
  scale_color_manual(values = c("brown1", "mediumseagreen")) + 
  coord_cartesian(ylim=c(0, 4000000)) +
  ggtitle("Day-59") +
...
### Time 4
######## T4 model
m1.AF.T4<-gam(af_sum ~ Treatment + s(plant.mass..g, by= Treatment), subset = Time=="T4", data = fcm.df, method = "REML")

m2.AF.T4<-gam(af_sum ~  Treatment + s(plant.mass..g), subset = Time=="T4", data = fcm.df, method = "REML")

m3.AF.T4<-gam(af_sum ~  s(plant.mass..g), subset = Time=="T4", data = fcm.df, method = "REML")
...
AF.T4.mod.plot<-
  ...
  geom_point(data=fcm.df[(fcm.df$Time=="T4"),], 
             aes(x=plant.mass..g, y=af_sum, color=Treatment)) +
  scale_color_manual(values = c("brown1", "mediumseagreen")) + 
  coord_cartesian(ylim=c(0, 4000000)) +
  ggtitle("Day-89") +
...
### Time 1
######## T1 model
m1.SG.T1<-gam(sg_sum ~ Treatment + s(plant.mass..g, by= Treatment), subset = Time=="T1", data = fcm.df, method = "REML")

m2.SG.T1<-gam(sg_sum ~  Treatment + s(plant.mass..g), subset = Time=="T1", data = fcm.df, method = "REML")

m3.SG.T1<-gam(sg_sum ~  s(plant.mass..g), subset = Time=="T1", data = fcm.df, method = "REML")
...
### Time 3
######## T3 model
m1.SG.T3<-gam(sg_sum ~ Treatment + s(plant.mass..g, by= Treatment), subset = Time=="T3", data = fcm.df, method = "REML")

m2.SG.T3<-gam(sg_sum ~  Treatment + s(plant.mass..g), subset = Time=="T3", data = fcm.df, method = "REML")

m3.SG.T3<-gam(sg_sum ~  s(plant.mass..g), subset = Time=="T3", data = fcm.df, method = "REML")
...
### Time 4
######## T4 model
m1.SG.T4<-gam(sg_sum ~ Treatment + s(plant.mass..g, by= Treatment), subset = Time=="T4", data = fcm.df, method = "REML")

m2.SG.T4<-gam(sg_sum ~  Treatment + s(plant.mass..g), subset = Time=="T4", data = fcm.df, method = "REML")

m3.SG.T4<-gam(sg_sum ~  s(plant.mass..g), subset = Time=="T4", data = fcm.df, method = "REML")
